package com.mycompany.java_practice_project.OOP.Inheritance.TypesOfInheritance;

public class TypesOFInheritance {
    
    /*
     * There are four types Inheritance in OOP language. (-->) This Symbol means Extends
